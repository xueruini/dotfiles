...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("NanumGothicCoding" ;; "FuraCode Nerd Font" "Input Mono Narrow"
                               :size 15
                               :weight normal
                               :width normal
                               :powerline-scale 1.1)
